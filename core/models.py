...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Thrift.ke")
    ...
    address = models.CharField(max_length=100, default="123 Koinange Street.")
...
class Product(models.Model):
    ...
    title = models.CharField(max_length=100, default="Blue Jeans")
    image = models.ImageField(
...
class CartOrderProducts(models.Model):
    ...
    total = models.DecimalField(max_digits=12, decimal_places=2, default="200")
